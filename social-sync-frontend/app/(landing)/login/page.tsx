    ...
    if (email === "test@example.com" && password === "test@123") {
      ...
      setTimeout(() => {
        ...
        toast({
          ...
          description: "Welcome back to SocialSync!",
        })
      ...
      setTimeout(() => {
        setIsLoading(false)
        setError("Invalid email or password. Try test@example.com / test@123")
      }, 1000)
    }
  }
        ...
        <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
          ...
          <form onSubmit={handleLogin}>
            <CardContent className="space-y-4">
              {error && (
                <div className="p-3 text-sm rounded-md bg-red-50 text-red-600 dark:bg-red-900/30 dark:text-red-400">
                  {error}
                </div>
              )}
